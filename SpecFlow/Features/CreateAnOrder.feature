...
Scenario Outline: creating an order
	...
	When user makes an order for that pet with parameters <id>, <petId>, <quantity>, <shipDate>, <status>, <complete>
	Then an order has been placed with parameters <id>, <petId>, <quantity>, <shipDate>, <status>, <complete>
		  Examples:
